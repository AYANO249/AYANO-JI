...
const handler = async (m, { conn, text, bot }) => {
  if (!text) return m.reply("⚜️ ~ ضع نص جنب الأمر ~ ⚜️");
  ...
  const prompt = `
انت بوت واتساب بـ اسم [إيرين، Eren] تجسيد لـ شخصية Eren Yeager من انمي [Attack on Titan] وتكلم بـ لجهة مصرية
